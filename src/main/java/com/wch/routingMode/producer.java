...
public class producer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        channel.exchangeDeclare(RabbitConstant.ROUTING, "direct", true, false, false, null);
        Iterator<Map.Entry<String, String>> it = infoMap.entrySet().iterator();
        while(it.hasNext()){
            Map.Entry<String,String> info = (Entry<String, String>) it.next();
            channel.basicPublish(RabbitConstant.ROUTING, info.getKey(), null, info.getValue().getBytes());
        }
